let toggleAnswer = (section, arrow) => {
    ...
    let allCollapsibleSections = document.getElementsByClassName('answer-text');
...
window.onload = () => {
    setTimeout(() => {
        toggleAnswer('order-process-answer', 'order-process-arrow')
    }, 700);
}